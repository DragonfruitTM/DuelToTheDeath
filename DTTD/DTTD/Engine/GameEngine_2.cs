/* PASTE THESE COMMANDS IN THE CONSOLE TO TEST
Create Ivan Mage Ork
Create Petar Mage Human
Equip Ivan Axe
Equip Petar Armor
Cast Ivan BlackMagicAttack Petar
Cast Peter BlackMagicAttack Ivan
*/
...
namespace DTTD.Engine
{
    ...
    public class GameEngine : IEngine
    {
        ...
        public void Start()
        {
            Console.WriteLine("Please, create at least two players.");
            Console.WriteLine("To create a player, enter: Create (PlayerName) (Class) (Race)");
        ...
        private string ProcessSingleCommand(IComand command)
        {
            ...
            switch (command.Parameters[0])
            {
                ...
                case "Equip":
                    ...
                    {
                        return "Equip command should have 2 parameters"; // We could change this
                    }
